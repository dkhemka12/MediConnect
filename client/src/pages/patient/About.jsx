...
// Static highlights data for the about page
const highlights = [
  {
...
const About = () => {
  // Maps and renders highlights array with consistent component structure
  return (
    <main className="about-page">
      ...
      <section className="about-grid">
        <article className="about-card">
          ...
          <p>
            ...
            is to reduce delays and improve patient outcomes by creating a
            smooth digital experience for both patients and providers.
          </p>
        </article>
      ...
      <section className="about-highlights">
        {/* Map highlights array to display cards */}
        {highlights.map((item) => (
