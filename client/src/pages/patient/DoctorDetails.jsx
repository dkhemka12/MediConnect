...
const DoctorDetails = () => {
  ...
  const doctorView = selectedDoctor
    ? {
        ...
        bio:
          selectedDoctor.bio ||
          "Experienced doctor available for consultation.",
        languages: selectedDoctor.languages || "English",
        tags: selectedDoctor.tags || [
          selectedDoctor.specialty || "General Care",
        ],
  ...
  const handleOpenBooking = () => {
    ...
    if (!isAuthenticated()) {
      navigate("/login", {
        state: { from: `/patient/book-appointment/${doctorView.id}` },
      });
      return;
    }
            ...
            <div className="profile-top">
              ...
              <div className="profile-text">
                ...
                <p className="meta-text">
                  ⭐ {doctorView.rating} ({doctorView.reviews} reviews) •{" "}
                  {doctorView.experienceYears} years exp. •{" "}
                  {doctorView.patientsTreated} patients
                </p>
