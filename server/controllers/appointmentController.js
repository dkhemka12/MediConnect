...
// The whole point of this file is to handle the logic / operations for Appointments.
// `bookAppointment` allows users to create appointments with doctors.
// `getAppointments` fetches appointments securely, so patients only see their own, and doctors only see theirs.
// `updateAppointmentStatus` allows updating an appointment context (e.g. approving or cancelling it).
